...
// NFTLevelMetaDataURI is an auto generated low-level Go binding around an user-defined struct.
type NFTLevelMetaDataURI struct {
	Level string
	Uri   string
}
...
// LevelToMetaDataURI is a free data retrieval call binding the contract method 0x53bb4b7f.
//
// Solidity: function levelToMetaDataURI(string ) view returns(string)
func (_Nft *NftCaller) LevelToMetaDataURI(opts *bind.CallOpts, arg0 string) (string, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "levelToMetaDataURI", arg0)
...
//
// Solidity: function levelToMetaDataURI(string ) view returns(string)
func (_Nft *NftSession) LevelToMetaDataURI(arg0 string) (string, error) {
	return _Nft.Contract.LevelToMetaDataURI(&_Nft.CallOpts, arg0)
}

// LevelToMetaDataURI is a free data retrieval call binding the contract method 0x53bb4b7f.
//
// Solidity: function levelToMetaDataURI(string ) view returns(string)
func (_Nft *NftCallerSession) LevelToMetaDataURI(arg0 string) (string, error) {
	return _Nft.Contract.LevelToMetaDataURI(&_Nft.CallOpts, arg0)
}
...
//
// Solidity: function safeMint(address to, string level) returns()
func (_Nft *NftTransactor) SafeMint(opts *bind.TransactOpts, to common.Address, level string) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "safeMint", to, level)
}

// SafeMint is a paid mutator transaction binding the contract method 0xd204c45e.
//
// Solidity: function safeMint(address to, string level) returns()
func (_Nft *NftSession) SafeMint(to common.Address, level string) (*types.Transaction, error) {
	return _Nft.Contract.SafeMint(&_Nft.TransactOpts, to, level)
}

// SafeMint is a paid mutator transaction binding the contract method 0xd204c45e.
//
// Solidity: function safeMint(address to, string level) returns()
func (_Nft *NftTransactorSession) SafeMint(to common.Address, level string) (*types.Transaction, error) {
	return _Nft.Contract.SafeMint(&_Nft.TransactOpts, to, level)
}
...
// TriggerNFTDeployedEvent is a paid mutator transaction binding the contract method 0xc3841f67.
//
// Solidity: function triggerNFTDeployedEvent() returns()
func (_Nft *NftTransactor) TriggerNFTDeployedEvent(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "triggerNFTDeployedEvent")
}

// TriggerNFTDeployedEvent is a paid mutator transaction binding the contract method 0xc3841f67.
//
// Solidity: function triggerNFTDeployedEvent() returns()
func (_Nft *NftSession) TriggerNFTDeployedEvent() (*types.Transaction, error) {
	return _Nft.Contract.TriggerNFTDeployedEvent(&_Nft.TransactOpts)
}

// TriggerNFTDeployedEvent is a paid mutator transaction binding the contract method 0xc3841f67.
//
// Solidity: function triggerNFTDeployedEvent() returns()
func (_Nft *NftTransactorSession) TriggerNFTDeployedEvent() (*types.Transaction, error) {
	return _Nft.Contract.TriggerNFTDeployedEvent(&_Nft.TransactOpts)
}
...
// NftBatchMetadataUpdateIterator is returned from FilterBatchMetadataUpdate and is used to iterate over the raw logs and unpacked data for BatchMetadataUpdate events raised by the Nft contract.
type NftBatchMetadataUpdateIterator struct {
	Event *NftBatchMetadataUpdate // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NftBatchMetadataUpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(NftBatchMetadataUpdate)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NftBatchMetadataUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NftBatchMetadataUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NftBatchMetadataUpdate represents a BatchMetadataUpdate event raised by the Nft contract.
type NftBatchMetadataUpdate struct {
	FromTokenId *big.Int
	ToTokenId   *big.Int
	Raw         types.Log // Blockchain specific contextual infos
}
...
func (_Nft *NftFilterer) FilterBatchMetadataUpdate(opts *bind.FilterOpts) (*NftBatchMetadataUpdateIterator, error) {

	logs, sub, err := _Nft.contract.FilterLogs(opts, "BatchMetadataUpdate")
	if err != nil {
		return nil, err
	}
	return &NftBatchMetadataUpdateIterator{contract: _Nft.contract, event: "BatchMetadataUpdate", logs: logs, sub: sub}, nil
}

// WatchBatchMetadataUpdate is a free log subscription operation binding the contract event 0x6bd5c950a8d8df17f772f5af37cb3655737899cbf903264b9795592da439661c.
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
func (_Nft *NftFilterer) WatchBatchMetadataUpdate(opts *bind.WatchOpts, sink chan<- *NftBatchMetadataUpdate) (event.Subscription, error) {

	logs, sub, err := _Nft.contract.WatchLogs(opts, "BatchMetadataUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NftBatchMetadataUpdate)
				if err := _Nft.contract.UnpackLog(event, "BatchMetadataUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
func (_Nft *NftFilterer) ParseBatchMetadataUpdate(log types.Log) (*NftBatchMetadataUpdate, error) {
	event := new(NftBatchMetadataUpdate)
	if err := _Nft.contract.UnpackLog(event, "BatchMetadataUpdate", log); err != nil {
		return nil, err
	}
...
// NftMetadataUpdateIterator is returned from FilterMetadataUpdate and is used to iterate over the raw logs and unpacked data for MetadataUpdate events raised by the Nft contract.
type NftMetadataUpdateIterator struct {
	Event *NftMetadataUpdate // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NftMetadataUpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(NftMetadataUpdate)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NftMetadataUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NftMetadataUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NftMetadataUpdate represents a MetadataUpdate event raised by the Nft contract.
type NftMetadataUpdate struct {
	TokenId *big.Int
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Nft *NftFilterer) FilterMetadataUpdate(opts *bind.FilterOpts) (*NftMetadataUpdateIterator, error) {

	logs, sub, err := _Nft.contract.FilterLogs(opts, "MetadataUpdate")
	if err != nil {
		return nil, err
	}
	return &NftMetadataUpdateIterator{contract: _Nft.contract, event: "MetadataUpdate", logs: logs, sub: sub}, nil
}

// WatchMetadataUpdate is a free log subscription operation binding the contract event 0xf8e1a15aba9398e019f0b49df1a4fde98ee17ae345cb5f6b5e2c27f5033e8ce7.
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
func (_Nft *NftFilterer) WatchMetadataUpdate(opts *bind.WatchOpts, sink chan<- *NftMetadataUpdate) (event.Subscription, error) {

	logs, sub, err := _Nft.contract.WatchLogs(opts, "MetadataUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NftMetadataUpdate)
				if err := _Nft.contract.UnpackLog(event, "MetadataUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
func (_Nft *NftFilterer) ParseMetadataUpdate(log types.Log) (*NftMetadataUpdate, error) {
	event := new(NftMetadataUpdate)
	if err := _Nft.contract.UnpackLog(event, "MetadataUpdate", log); err != nil {
		return nil, err
	}
...
// NftNFTDeployedIterator is returned from FilterNFTDeployed and is used to iterate over the raw logs and unpacked data for NFTDeployed events raised by the Nft contract.
type NftNFTDeployedIterator struct {
	Event *NftNFTDeployed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NftNFTDeployedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NftNFTDeployedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NftNFTDeployedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NftNFTDeployed represents a NFTDeployed event raised by the Nft contract.
type NftNFTDeployed struct {
	LevelToMetaDataURIs []NFTLevelMetaDataURI
	Raw                 types.Log // Blockchain specific contextual infos
}

// FilterNFTDeployed is a free log retrieval operation binding the contract event 0x9ffd666ccee48e842799130b57c3fa98e6fab07fa23e7d164c8c209b9a96f026.
//
// Solidity: event NFTDeployed((string,string)[] levelToMetaDataURIs)
func (_Nft *NftFilterer) FilterNFTDeployed(opts *bind.FilterOpts) (*NftNFTDeployedIterator, error) {

	logs, sub, err := _Nft.contract.FilterLogs(opts, "NFTDeployed")
	if err != nil {
		return nil, err
	}
	return &NftNFTDeployedIterator{contract: _Nft.contract, event: "NFTDeployed", logs: logs, sub: sub}, nil
}

// WatchNFTDeployed is a free log subscription operation binding the contract event 0x9ffd666ccee48e842799130b57c3fa98e6fab07fa23e7d164c8c209b9a96f026.
//
// Solidity: event NFTDeployed((string,string)[] levelToMetaDataURIs)
func (_Nft *NftFilterer) WatchNFTDeployed(opts *bind.WatchOpts, sink chan<- *NftNFTDeployed) (event.Subscription, error) {

	logs, sub, err := _Nft.contract.WatchLogs(opts, "NFTDeployed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NftNFTDeployed)
				if err := _Nft.contract.UnpackLog(event, "NFTDeployed", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNFTDeployed is a log parse operation binding the contract event 0x9ffd666ccee48e842799130b57c3fa98e6fab07fa23e7d164c8c209b9a96f026.
//
// Solidity: event NFTDeployed((string,string)[] levelToMetaDataURIs)
func (_Nft *NftFilterer) ParseNFTDeployed(log types.Log) (*NftNFTDeployed, error) {
	event := new(NftNFTDeployed)
	if err := _Nft.contract.UnpackLog(event, "NFTDeployed", log); err != nil {
		return nil, err
	}
...
// NftNFTMintedIterator is returned from FilterNFTMinted and is used to iterate over the raw logs and unpacked data for NFTMinted events raised by the Nft contract.
type NftNFTMintedIterator struct {
	Event *NftNFTMinted // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NftNFTMintedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NftNFTMintedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NftNFTMintedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NftNFTMinted represents a NFTMinted event raised by the Nft contract.
type NftNFTMinted struct {
	To      common.Address
	TokenId *big.Int
	Level   string
	Raw     types.Log // Blockchain specific contextual infos
...
//
// Solidity: event NFTMinted(address to, uint256 tokenId, string level)
func (_Nft *NftFilterer) FilterNFTMinted(opts *bind.FilterOpts) (*NftNFTMintedIterator, error) {

	logs, sub, err := _Nft.contract.FilterLogs(opts, "NFTMinted")
	if err != nil {
		return nil, err
	}
	return &NftNFTMintedIterator{contract: _Nft.contract, event: "NFTMinted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NFTMinted(address to, uint256 tokenId, string level)
func (_Nft *NftFilterer) WatchNFTMinted(opts *bind.WatchOpts, sink chan<- *NftNFTMinted) (event.Subscription, error) {

	logs, sub, err := _Nft.contract.WatchLogs(opts, "NFTMinted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NftNFTMinted)
				if err := _Nft.contract.UnpackLog(event, "NFTMinted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NFTMinted(address to, uint256 tokenId, string level)
func (_Nft *NftFilterer) ParseNFTMinted(log types.Log) (*NftNFTMinted, error) {
	event := new(NftNFTMinted)
	if err := _Nft.contract.UnpackLog(event, "NFTMinted", log); err != nil {
		return nil, err
	}
